...
urlpatterns = [
    ...
    url(r'^(?P<employee_id>\d+)/list/group/category/$',
        stars_employee_list_group_by_category,
        name='stars_employee_list_group_by_category'),
    url(r'^(?P<employee_id>\d+)/list/group/keyword/$',
        stars_employee_list_group_by_keyword,
        name='stars_employee_list_group_by_keyword'),
    ...
    url(r'^badge/(?P<badge_id>\d+)/employee/list/$',
        employee_list_group_by_badges_detail,
        name='employee_list_group_by_badges_detail'),
    ...
    url(r'^top/(?P<top_number>\d+)/(?P<kind>\w+)/(?P<id>\d+)/',
        stars_top_employee_lists,
        name='stars_top_employee_lists'),
]
