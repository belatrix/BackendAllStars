...
CONSTANCE_CONFIG = {
    ...
    'EMAIL_DOMAIN_FORBIDDEN': ('Email domain %s is forbidden.',
                               'Error message when email domain is not in email domain list'),
    'EMAIL_SERVICE_ERROR': ('There are problems with email service, please contact an administrator.',
                            'Error message when email service is not available.'),
    'INVALID_EMAIL_ADDRESS': ('%s is not a valid email address.', 'Error message when email address is invalid.'),

    # Categories messages
    'KEYWORD_ALREADY_EXISTS': ('Data already exists or is invalid.',
    ...
    'EMPLOYEE_CREATION_SUBJECT': ('[BELATRIX CONNECT] Your account has been successfully created.',
                                  'Email subject when new account is created.'),
    'EMPLOYEE_CREATION_MESSAGE': ('Your username is: %s and your initial random password is %s',
                                  'Email message when new account is created'),
    'EMPLOYEE_RESET_PASSWORD_CONFIRMATION_SUBJECT': (
        '[BELATRIX CONNECT] Please confirm if you want a password reset.',
        'Confirmation reset password email subject.'),
    'EMPLOYEE_RESET_PASSWORD_CONFIRMATION_MESSAGE': (
        'If you want to reset your password please confirm the request, clicking here: %s',
        'Confirmation reset password email message.'),
    'EMPLOYEE_RESET_PASSWORD_SUCCESSFULLY_SUBJECT': (
        '[BELATRIX CONNECT] Your new password has been successfully created.',
        'Reset password successfully email subject '),
    'EMPLOYEE_RESET_PASSWORD_SUCCESSFULLY_MESSAGE': ('Your new password is: %s',
                                                     'Reset password successfully email message.'),
    'USER_EMAIL_ALREADY_REGISTERED': ('email %s is already registered.', 'Error message when user already exists.'),
    'USER_SUCCESSFULLY_CREATED': ('User(s) successfully created.',
                                  'Message when an account has been created successfully.'),
    'USER_SUCCESSFULLY_CREATED_EMAIL_ERROR': (
        'User was created, but there are problems with email service, please contact an administrator.',
        'Message when an account has been created successfully but no email was sent.'),
    'USER_SUCCESSFULLY_RESET_PASSWORD': ('Successfully password creation, email has been sent.',
                                         'Successfully user reset password.'),
    'USER_UNABLE_TO_LOG': ('User is unable to log in with provided credentials.',
                           'Error message when user are not able to log in'),
    ...
    'USER_BLOCKED_TO_RECEIVED_STARS': ('User is blocked to received recommendations.',
                                       'Error message when user is blocked to received recommendations.'),
    ...
    'USER_UNABLE_TO_GIVE_BADGES_ITSELF': ('User is unable to give badges to itself.',
                                          'Error message when user is unable to give badges to itself.'),
    'NO_STARS_RECEIVED': ('No recommendations yet.', "Message when user doesn't have recommendations yet."),

    # Daily cron tasks messages
    'DAILY_EXECUTION_CONFIRMATION_SUBJECT': ('[BELATRIX CONNECT] Daily check has been executed.',
                                             'Email confirmation subject for daily tasks.'),
    'DAILY_EXECUTION_CONFIRMATION_MESSAGE': ('Your daily check scores and rules has been executed.',
                                             'Email confirmation message for daily tasks.'),
    'DAILY_EXECUTION_CONFIRMATION_EMAIL': ('sergio@neosergio.net',
                                           'Email address to send daily message for daily tasks.'),
    ...
    'USER_BLOCKED_NOTIFICATION_MESSAGE': (
        'Your username %s is blocked. Please contact with your project leader for more details.',
    ...
    'RECOMMENDATION_MESSAGE': ('You earn %d point(s), %s %s gives you a recommendation',
                               'Message when user receives a recommendation'),
